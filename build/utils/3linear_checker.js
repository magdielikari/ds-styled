 ...
 * @param {string} z_gradient  lowest priority
 * @param {string} defultVal   default value
 * @param {string} independent value added at the end
 */
var fn = function fn(x_gradient, y_gradient, z_gradient, defultVal, independent) {
  return (x_gradient ? x_gradient : y_gradient ? y_gradient : z_gradient ? z_gradient : defultVal) + independent;
};
