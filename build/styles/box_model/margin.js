...
var mar = (0, _styledComponents.css)(["margin:", ";"], function (props) {
  return (0, _linear_checker.default)(props.mtop, props.mrow, props.mctr, props.mctl, props.mall, defaultValue, 'px ') + (0, _linear_checker.default)(props.mrig, props.mcol, props.mcbl, props.mctl, props.mall, defaultValue, 'px ') + (0, _linear_checker.default)(props.mbot, props.mrow, props.mcbl, props.mcbr, props.mall, defaultValue, 'px ') + (0, _linear_checker.default)(props.mlef, props.mcol, props.mctr, props.mcbr, props.mall, defaultValue, 'px');
});
mar.propTypes = {
